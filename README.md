...
<img width="4000" height="2252" alt="UsageView dashboard preview" src="https://github.com/user-attachments/assets/1a8bdb89-fc78-41f2-8d1a-605240621eae" />

UsageView is a Windows tray app for showing Codex usage, Codex limits, PC stats, Spotify now playing, and time on a clean customizable LAN dashboard.
...
- You do not log in to Codex through UsageView. Codex usage is read locally from this machine.
- UsageView does not send analytics or app logs to a UsageView server.
...
If you have a different Codex install path, no local telemetry, or a future Codex version changes the file format, the widget shows unavailable or partial data instead of guessing. Custom paths can be set with `CODEX_LOG_PATH`, `CODEX_SESSIONS_PATH`, and `CODEX_STATUS_PATH` in development.
